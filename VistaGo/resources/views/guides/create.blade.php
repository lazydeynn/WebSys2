<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Register Tour Guide</h2>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('guides.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                        @csrf
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="specialization" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                    <option value="Heritage Guide">Heritage Guide</option>
                                    <option value="Mountain Guide">Mountain Guide</option>
                                    <option value="City Tour Guide">City Tour Guide</option>
                                    <option value="Island Hopping">Island Hopping</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Daily Rate (₱)</label>
                                <input type="number" step="0.01" name="daily_rate" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                            </div>
                        </div>
